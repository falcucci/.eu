    ...
    <PageWrapper>
      ...
      <CoWrapper>
        ...
        <Co
          ...
          pretext={'2023-2024'}
          what={`
            Open-source contributor to the Mithril, a research project whose goal is to provide Stake-based Threshold Multisignatures on top of the blockchain network.`}
        />
        <Co
